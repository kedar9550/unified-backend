...
exports.hodActionRole = async (req, res) => {
    try {
        ...
        const isManagementRole = userRoles.some(r => [
            ...
            "DY. PRO CHANCELLOR", "DY_PRO_CHANCELLOR", "DY PRO CHANCELLOR",
            "REGISTRAR",
            "PRO VICE-CHANCELLOR (E & S)", "PRO_VICE_CHANCELLOR_E_S", "PRO VICE CHANCELLOR (E & S)", "PRO VICE-CHANCELLOR (ENGG.&SCI.)", "PRO VICE CHANCELLOR (ENGG.&SCI.)",
            "PRO VICE-CHANCELLOR (A)", "PRO_VICE_CHANCELLOR_A", "PRO VICE CHANCELLOR (A)", "PRO VICE-CHANCELLOR(A)",
            "PRO VICE-CHANCELLOR (S & P)", "PRO_VICE_CHANCELLOR_S_P", "PRO VICE CHANCELLOR (S & P)", "PRO VICE-CHANCELLOR(S & P)",
            "DEAN - (IQAC)", "DEAN_IQAC", "DEAN (IQAC)", "DEAN-(IQAC)",
            "DEAN - (ADMISSIONS)", "DEAN_ADMISSIONS", "DEAN (ADMISSIONS)", "DEAN-(ADMISSIONS)",
