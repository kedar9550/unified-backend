...
exports.createNovelProduct = async (req, res) => {
    try {
        ...
        const product = new NovelProduct({
            ...
            developedOrganization: data.category === 'Developed' && data.developedOrganization ? data.developedOrganization.trim() : undefined,
            implementedOrganization: data.category === 'Implemented' && data.implementedOrganization ? data.implementedOrganization.trim() : undefined,
